...
// Import the overweight-specific fragments
import com.example.tiny.fragments.OGrowthChartFragment;
import com.example.tiny.fragments.ODietFragment;
import com.example.tiny.fragments.OFoodRecommendationFragment;
...
public class OverweightActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Load the default fragment (e.g., Overweight Growth Chart)
        loadFragment(new OGrowthChartFragment());
    }
    ...
    private void setupBottomNavigation() {
        ...
        bottomNav.setOnItemSelectedListener(item -> {
            ...
            if (itemId == R.id.nav_growth) {
                selectedFragment = new OGrowthChartFragment(); // Overweight Growth Chart
            } else if (itemId == R.id.nav_diet) {
                selectedFragment = new ODietFragment(); // Overweight Dietary Recommendations
            } else if (itemId == R.id.nav_food) {
                selectedFragment = new OFoodRecommendationFragment(); // Overweight Food Recommendations
            }
